<%@ Page Language="c#" Codebehind="GcEpiTemplateMappings.aspx.cs" AutoEventWireup="False" Inherits="GcEpiPluginV2._0.modules.GatherContentImport.GcEpiTemplateMappings" Title="GcEpiTemplateMappings" %>
<html>
            ...
            <table class="auto-style4">
                <asp:Repeater runat="server" ID="rptTableMappings" OnItemCreated="RptTableMappings_OnItemCreated">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                <h4><asp:CheckBox ID="chkTemplate" runat="server" /></h4>
                            </td>
                            <td>
                                <asp:Button runat="server" ID="btnEditTemplateMap"  Text="Edit Mapping" OnClientClick="loadingAnimation()">
                                </asp:Button> &nbsp; &nbsp;
                                <asp:Button runat="server" ID="btnItemsReview" Text="Review Items" OnClientClick="loadingAnimation()">   
                                </asp:Button>
                            </td>
                            <td><asp:HyperLink runat="server" ID="lnkTemplate" Target="_blank" CssClass="LinkNoUnderline"/></td>
                            <td><asp:HyperLink runat="server" ID="lnkProject" Target="_blank" CssClass="LinkNoUnderline"/></td>
                            <td>
