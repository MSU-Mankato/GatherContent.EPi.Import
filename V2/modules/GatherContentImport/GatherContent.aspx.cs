...
{
    [GuiPlugIn(DisplayName = "GatherContent Config Setup", Description = "GatherContent Account and Settings", Area = PlugInArea.AdminMenu, Url = "~/modules/GatherContentImport/GatherContent.aspx")]
