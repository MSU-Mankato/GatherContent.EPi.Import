...
using GcEpiPluginV2._0.modules.GatherContentImport.GcEpiObjects;
...
{
    [GuiPlugIn(DisplayName = "New Gc Mapping Step 4", Description = "This is where the user maps the fields from GC to EPi", Area = PlugInArea.AdminMenu, Url = "~/modules/GatherContentImport/NewGcMappingStep4.aspx")]
    public partial class NewGcMappingStep4 : SimplePage
    {
        ...
        private void PopulateForm()
        {
            ...
            {
                Response.Write("<script>alert('Please set the MetaDataProducer Defaults!');window.location='/modules/GatherContentImport/NewGcMappingStep3.aspx'</script>");
                Visible = false;
                return;
            }
