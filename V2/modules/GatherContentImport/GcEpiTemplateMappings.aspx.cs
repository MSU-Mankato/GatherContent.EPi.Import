...
namespace GcEpiPluginV2._0.modules.GatherContentImport
{
    ...
    [GuiPlugIn(DisplayName = "Gc Epi Template Mappings", Description = "This is where the user has access to all the mappings.", Area = PlugInArea.AdminMenu, Url = "~/modules/GatherContentImport/GcEpiTemplateMappings.aspx")]
    public partial class GcEpiTemplateMappings : SimplePage
    {
        ...
        protected void BtnDeleteTemplate_OnClick(object sender, EventArgs e)
        {
            ...
            const string windowLocation = "window.location = '/modules/GatherContentImport/GcEpiTemplateMappings.aspx'";
