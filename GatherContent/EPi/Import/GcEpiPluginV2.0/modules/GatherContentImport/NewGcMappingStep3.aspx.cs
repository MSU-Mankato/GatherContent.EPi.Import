...
{
    [GuiPlugIn(DisplayName = "New Gc Mapping Step 3", Description = "This is where the user sets mapping defaults", Area = PlugInArea.AdminMenu, Url = "~/modules/GatherContentImport/NewGcMappingStep3.aspx")]
